...
<div class="container">
	<div class="row">
		<div class="col-sm-12 col-md-12 col-lg-12">
			...
			$sql = "SELECT Email, Contrasena FROM administradores WHERE Email='$email'";				
			...
			if (mysqli_num_rows($result) > 0) {				
				...
				$body = "Your password is:" . $row['Contrasena'];
				
				$headers = 'From: sebastiancalderon1597@mail.com' . "\r\n" .
				'Reply-To: sebastiancalderon1597@mail.com' . "\r\n" .
